...
// Refering to all the properties within Joe as well as prototypes
// 2. What is "this" when joe.scopeArrow() is invoked?
// Showing window object and the methods
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions retain the this value of the enclosing functional scope. Therefore, you will want to avoid using an arrow function in a constructor (where we need the contextual this to be the object we are building) or any method that needs to use this to behave properly.